...
var DefaultGenerator, _ = NewGenerator(8)
...
func DecodeInvite(code string) uint64 {
	return DefaultGenerator.Decode(code)
}

func EncodeInvite(id uint64) (string, error) {
	return DefaultGenerator.Encode(id)
}
